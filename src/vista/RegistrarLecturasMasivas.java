...
public class RegistrarLecturasMasivas extends Container {
    ...
    private JFileChooser archivoLecturas;
    ...
    private void iniciarComponentes() {
        ...
        archivoLecturas = new JFileChooser();
        ...
        seleccionar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                archivoLecturas.showOpenDialog(null);
                lecturas.setText(archivoLecturas.getSelectedFile().getAbsolutePath());
            }
